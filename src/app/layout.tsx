      ...
      <body className="min-h-screen bg-system-bg font-mono text-system-text antialiased">
        ...
        <nav className="fixed inset-x-0 bottom-0 border-t border-system-border/40 bg-system-panel/90 backdrop-blur">
          <div className="mx-auto flex max-w-3xl">
            <Link href="/" className="flex-1 py-4 text-center text-sm uppercase tracking-widest hover:text-system-accent">
              Statut
            </Link>
            <Link href="/quetes" className="flex-1 py-4 text-center text-sm uppercase tracking-widest hover:text-system-accent">
              Quêtes
            </Link>
          </div>
        </nav>
